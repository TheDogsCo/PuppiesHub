...
{
    public static class MessageAlertConstants
    {
        public const string EmptyfieldError = "Please fill out all fields.";
        public static string PasswordNotMatching = "Passwords Not Matching.";
